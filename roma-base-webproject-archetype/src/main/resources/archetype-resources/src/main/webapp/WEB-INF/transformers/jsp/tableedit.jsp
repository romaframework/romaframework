        ...
        <thead id="<%=JaniculumWrapper.id(component, "header")%>" class="<%=JaniculumWrapper.cssClass(component, "tableedit", "header")%>">
            <tr class="<%=JaniculumWrapper.cssClass(component, "tableedit", "header_row")%>">
                ...
                %>
                            ...
                            <th class="table_selection">${symbol_pound} <input class="table_selection" name="<%=JaniculumWrapper.fieldName(component)%>_-1" type="hidden" 
                            value="1" /></th>
                    <%}
...
<roma:addjs>
 ${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, "content") %>').tablesorter();
</roma:addjs>