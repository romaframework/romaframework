			...
			<table id="<%=JaniculumWrapper.id(component, "content")%>"
				...
				<thead id="<%=JaniculumWrapper.id(component, "header")%>"
					...
					<tr
						...
						%>
						<th class="table_selection">${symbol_pound} <input class="table_selection"
...
<roma:addjs>
${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, "content")%>').tablesorter({ headers: { 0: { sorter: false } } });
</roma:addjs>
