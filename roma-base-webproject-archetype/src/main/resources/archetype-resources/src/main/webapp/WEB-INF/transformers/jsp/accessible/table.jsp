                ...
                <tr class="<%=JaniculumWrapper.cssClass(component, "table", "header_row")%>">
                    <%if(JaniculumWrapper.selectionAviable(component)){
                        if(JaniculumWrapper.isMultiSelection(component)){ %>
                               <th class="table_selection">${symbol_pound} <input id="<%=JaniculumWrapper.id(component, null)%>_table_selection" class="table_selection" name="<%=JaniculumWrapper.fieldName(component)%>_-1" type="hidden" 
