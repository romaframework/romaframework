...
<roma:addjs>
${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, null)%>[toRemove="toRemove"]').remove();
var size = ${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, null)%> > div').width();
${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, null)%>').dialog({
	modal:true,
...
romaAddRemove('<%=JaniculumWrapper.id(component, null)%>',function(){
	${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, null)%>').dialog('destroy');
	${symbol_dollar}('${symbol_pound}<%=JaniculumWrapper.id(component, null)%>').attr('toRemove','toRemove');
});
</roma:addjs>