...
%>
<roma:addjs>
jQuery('${symbol_pound}<%= JaniculumWrapper.id(component, "content")%>').keyup(function(component){
	re = /[^0-9${symbol_escape}${symbol_escape}.,]/ ;
	re2 = /[^0-9${symbol_escape}${symbol_escape}-]/ ;
