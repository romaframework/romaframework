...
<roma:addjs>
jQuery('${symbol_pound}<%=JaniculumWrapper.id(component, "time")%>').timeEntry({spinnerImage: 'static/themes/default/image/spinnerDefault.png', show24Hours: true, showSeconds: true});
</roma:addjs>
