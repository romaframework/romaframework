...
<%
	...
	if (!style.containsRule("${symbol_pound}screen_main_popups")) {
		style.createRules("${symbol_pound}screen_main_popups");
	}
	style.addRule("${symbol_pound}screen_main_popups", "background-repeat", "repeat-x");
	style.addRule("${symbol_pound}screen_main_popups", "position", "fixed");
	style.addRule("${symbol_pound}screen_main_popups", "top", "0");
	style.addRule("${symbol_pound}screen_main_popups", "bottom", "0");
	style.addRule("${symbol_pound}screen_main_popups", "left", "0");
	style.addRule("${symbol_pound}screen_main_popups", "z-index", "1000");
	style.addRule("${symbol_pound}screen_main_popups", "width", "100%");
	style.addRule("${symbol_pound}screen_main_popups", "height", "100%");
	style.addRule("${symbol_pound}screen_main_popups", "background-image", "url(/"+Roma.view().getContextPath() + "/static/themes/default/image/test01.png)");
%>