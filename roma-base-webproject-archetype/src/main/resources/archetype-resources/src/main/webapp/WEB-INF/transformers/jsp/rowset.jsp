...
<table id="<%=JaniculumWrapper.id(component, null)%>" class="<%=JaniculumWrapper.cssClass(component, "rowset", null)%>" style="<%=JaniculumWrapper.inlineStyle(component, null)%>">
   ...
   <%
	   	JspTransformerHelper.addCss("${symbol_pound}"+JaniculumWrapper.id(component, null)+"_"+row+"_td", "vertical-align", valign);
	   	JspTransformerHelper.addCss("${symbol_pound}"+JaniculumWrapper.id(component, null)+"_"+row+"_td", "text-align", halign);
		row++;
	}
   %>
</table>